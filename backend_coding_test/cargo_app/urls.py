...
from .views import (
    ...
    CountryListCreateAPIView, CountryDetailAPIView, CategoryListCreateAPIView, CategoryDetailAPIView
)
...
urlpatterns = [
    ...
    path('api/countries/', CountryListCreateAPIView.as_view(), name='api-country-list-create'),
    path('api/countries/<int:pk>/', CountryDetailAPIView.as_view(), name='api-country-detail'),
